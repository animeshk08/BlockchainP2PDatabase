...
"""
This class contains a basic implementation of the blockchain
"""
class Blockchain:
    def __init__(self):
        """
    ...
    def valid_chain(self, chain):
        """
        Determine if a given blockchain is valid before adding to the blockchain
    ...
    def resolve_conflicts(self):
        ...
        This method is of significance when adding multiple nodes to the blockchain.
    ...
    def mine(self, type, body):
        """
        Mine a new block into the block chain.
        :param type: type of blockchain block   
        :param body: data stored inside the block
